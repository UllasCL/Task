...
public class CommonServiceRefundStatus extends BaseTest {
    ...
    public void TestCase1() {
        ...
        String urlGet = properties.getProperty("common.service.refundState.url")+"?orderId="+""+"&categoryId="+"1";
    ...
    public void TestCase2() {
        ...
        String urlGet = properties.getProperty("common.service.refundState.url")+"?orderId="+"8deefb6b-6b16-4441-b180-6f5d6d6741ca"+"&categoryId="+"";
    ...
    public void TestCase3() {
        ...
        String urlGet = properties.getProperty("common.service.refundState.url")+"?orderId="+"INVALID"+"&categoryId="+"1";
    ...
    public void TestCase4() {
        ...
        String urlGet = properties.getProperty("common.service.refundState.url")+"?orderId="+"8deefb6b-6b16-4441-b180-6f5d6d6741ca"+"&categoryId="+"111";
    ...
    public void TestCase5() {
        ...
        String urlGet = properties.getProperty("common.service.refundState.url")+"?orderId="+"8deefb6b-6b16-4441-b180-6f5d6d6741ca"+"&categoryId="+"1";
